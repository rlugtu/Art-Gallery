  ...
  return (
    <Flex flexDirection="column" py={60} px={135}>
      <Stack spacing={16} id="artEducation">
        ...
        <Text>
          Click here to read parts of{" "}
          <Text as="span" color="blue">
            <Link color="blue" href="/footprints-preview">
              {" "}
              Footprints and New Worlds
            </Link>
          </Text>
        </Text>
        {/* <Text>Click here to read parts of Art and Education</Text> */}
      </Stack>
      ...
      <Stack>
        <Heading>TEACHING ART TEACHERS</Heading>
        <Text>
          “I am an artist and an art educator. I love both careers. I don’t
          believe you are really an artist unless you have a concept to share.
          On the other hand, you are not a good art educator unless you are a
        ...
        <Text>
          ...
          experience. Be humble. Don’t say “you call that art?” Come back again
          and again. Soon there will be communication, because you have reached
          out for understanding. I have my students work with art materials in
          all my courses because I believe, as Rousseau said, “Children may
          forget what they see, and sooner still what is said to them, but he
          they never forget what they have made.”
        </Text>
      </Stack>
